...
class YogaPopularScreen extends StatefulWidget {
  const YogaPopularScreen({super.key});

  @override
  State<YogaPopularScreen> createState() => _YogaPopularScreenState();
}

class _YogaPopularScreenState extends State<YogaPopularScreen> {
...
Future<List<YogaCourse>> fetchData(BuildContext context) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      final List<dynamic> jsonData = jsonDecode(response.body)['featured'];
